...
<div class="body-wrapper">
    ...
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Cadastro de Usuários</h5>
                    <div class="card">
                        <div class="card-body">
                            <?php 
                                echo form_open_multipart("admin/management/users/validate_user_registration");
                            ?> 
                                ...
                                <div class="container-fluid" style="display: <?php $msg = $this->session->tempdata('msg_register_correct'); echo isset($msg) ? "block" : "none"; ?>;">
                                    <div class='alert alert-success'>
                                        <?php $msg = $this->session->tempdata('msg_register_correct'); echo isset($msg) ? $this->session->tempdata('msg_register_correct') : "";  ?>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-fullname" class="form-label">Nome Completo</label>
                                        <input 
                                            type="text" 
                                            class="form-control" 
                                            id="text-fullname" 
                                            name="text-fullname"
                                            value="<?php echo set_value("text-fullname") ?>"
                                            >
                                    </div>
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-nickname" class="form-label">Usuário</label>
                                        <input 
                                            type="text" 
                                            class="form-control" 
                                            id="text-nickname" 
                                            name="text-nickname"
                                            value="<?php echo set_value("text-nickname") ?>"
                                            >
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-cpf" class="form-label">CPF</label>
                                        <input 
                                            onkeyup="formatarCPF()"
                                            maxlength="14" 
                                            type="text" 
                                            ...
                                            id="text-cpf" 
                                            name="text-cpf"
                                            value="<?php echo set_value("text-cpf") ?>"
                                            >
                                    </div>
                                    <div class="col col-12 col-sm-6 d-flex justify-content-center align-items-center">
                                        <div class="d-block mt-3">
                                            <label for="text-admin" class="form-label d-block">Admin</label>
                                            <input 
                                                type="checkbox" 
                                ...
                                <div class="row mb-3">
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-phone" class="form-label">Celular</label>
                                        <input 
                                            ...
                                            id="text-phone"
                                            name="text-phone"
                                            value="<?php echo set_value("text-phone") ?>"
                                            >
                                    </div>
                                    <div class="col col-12 col-sm-6 mt-3">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input 
                                        ...
                                        id="text-email" 
                                        name="text-email" 
                                        value="<?php echo set_value("text-email") ?>"
                                ...
                                <div class="row mb-3 ">
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-password" class="form-label">Senha</label>
                                        <input type="password" class="form-control" id="text-password" name="text-password">
                                    </div>
                                    <div class="col col-12 col-sm-6 mt-3">
                                        <label for="text-confirm_password" class="form-label">Confirmar Senha</label>
